<%--
    ...
    Author     : Tarek
--%>
<%@page import="beans.abscent_bean"%>
      ...
      <div class="content">
        <div class="container-fluid">
            ...
            <br>
              <div class="card">
                <div class="header">
                  <h4 class="title text-info">Liste des absences de la date : <i>${date}</i> </h4>
                </div>
                <div class="content table-responsive table-full-width">
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      <c:forEach items ="${absence}" var="item">
                        <tr>
